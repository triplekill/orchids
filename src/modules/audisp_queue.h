/*
  ...
  archive: http://people.redhat.com/sgrubb/audit/audit-2.0.5.tar.gz
  file: audit-2.0.5/audisp/queue.h

  The file was slightly modified in order to use this private structure.
 */
/* queue.h --
...
#include "libaudit.h"
/* #include "audispd-config.h" removed for orchids inclusion */
