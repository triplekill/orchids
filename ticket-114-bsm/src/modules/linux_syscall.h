// <asm/unistd_32.h> from a Linux system, modified by Jean Goubault-Larrecq for use with Orchids/mod_snare
// Each syscall is numbered __NR_<syscallname>: I changed
// each to LINUX_SYS_<syscallname> [jgl]
...
#define LINUX_SYS_getrlimit		 76   /* Back compatible 2Gig limited rlimit */
...
#define LINUX_SYS_afs_syscall	137 /* Syscall for Andrew File System */
...
#define LINUX_SYS_getpmsg		188	/* some people actually want streams */
#define LINUX_SYS_putpmsg		189	/* some people actually want streams */
#define LINUX_SYS_vfork		190
#define LINUX_SYS_ugetrlimit		191	/* SuS compliant getrlimit */
...
#define LINUX_SYS_madvise1		219	/* delete when C lib stub is removed */
